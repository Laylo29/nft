	...
	return (
		<div className='w-full sm:w-[330px] cursor-pointer'>
			<div className='w-full sm:w-[330px] sm:h-[330px] rounded-[20px] duration-300 overflow-hidden collection-img-wrapper'>
				<CustomImage classList='!mx-auto !duration-300' src={`${API}/file/${item.images[0]}`} alt="Collection-img" W={330} H={330}/>
			</div>
			<div className='flex justify-between mt-[15px]'>
				<div className='w-[30%] sm:h-[100px] rounded-[20px] !duration-300 overflow-hidden collection-img-wrapper'>
					<CustomImage classList='!w-full duration-300' src={`${API}/file/${item.images[1]}`} alt='Collection img' W={100} H={100}/>
				</div>
				<div className='w-[30%] sm:h-[100px] rounded-[20px] !duration-300 overflow-hidden collection-img-wrapper'>
					<CustomImage classList='!w-full duration-300' src={`${API}/file/${item.images[2]}`} alt='Collection img' W={100} H={100}/>
				</div>
