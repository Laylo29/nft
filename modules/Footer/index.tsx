      ...
      <div className="containers">
        <div className="flex justify-between">
            <div className="w-[243px]">
              ...
              <Text classList="mb-[20px] hover:text-[#A259FF] duration-500 ">NFT marketplace UI created with Anima for Figma.</Text>
              <Text classList="mb-[15px] hover:text-[#A259FF] duration-500">Join our community</Text>
            ...
            <div className="w-[133px]">
              ...
              <Link href={"/marketplace"}><Text classList="hover:text-[#A259FF] duration-500 mb-[20px]">Marketplace</Text></Link>
              <Link href={"/rangkings"}><Text classList="hover:text-[#A259FF] duration-500 mb-[20px]">Rankings</Text></Link>
              <Link href={"/connect-a-wallet"}><Text classList="hover:text-[#A259FF] duration-500 mb-[20px]">Connect a wallet</Text></Link>
            </div>

            <div className="w-[420px]">
              <Heading classList="mb-[25px]">Join our weekly digest</Heading>
              <Text classList="mb-[20px] w-[320px] hover:text-[#A259FF] duration-500">Get exclusive promotions & updates straight to your inbox.</Text>
              <SendEmail/>
            </div>
        </div>
      </div>
